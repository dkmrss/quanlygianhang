            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="row" style="padding: 0px; margin: 0px;">
                    <div class="col-sm-12 col-md-12">
                        <h2 style="text-align: center;">Chỉnh sửa mặt hàng</h2>
                    </div>
                    <div class="col-sm-12 col-md-6" style="margin: auto">
                        <?php $errors = isset($_SESSION['product_errors']) ? $_SESSION['product_errors'] : [] ?>
                        <form action="index.php?action=update&controller=product&id=<?= $product['id'] ?>" method="POST">
                            <div class="form-group">
                                <label for="name">Tên mặt hàng <sup class="required_errors">*</sup></label>
                                <input type="text" class="form-control" name="name" id="name" value="<?= isset($product['name']) ? $product['name'] : '' ?>" placeholder="Tên mặt hàng">
